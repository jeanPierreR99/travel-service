...
class ProviderCases {
    ...
    get() {
        return __awaiter(this, void 0, void 0, function* () {
            console.log(domain_1.CreateProviderDto);
    ...
    save(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (found) {
                if (found)
                    throw new Entity_1.ConflictException("Provider", data.name);
            }
            return yield this.impInterface.save(data);
        });
    }
}
exports.ProviderCases = ProviderCases;
