...
class CategoryCases {
    ...
    get() {
        return __awaiter(this, void 0, void 0, function* () {
            console.log(domain_1.CreateCategoryDto);
    ...
    save(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (found) {
                if (found)
                    throw new Entity_1.ConflictException("Category", data.name);
            }
            return yield this.impInterface.save(data);
        });
    }
}
exports.CategoryCases = CategoryCases;
